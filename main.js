...
var commodities = [adbot, router, stockbot, cracker, algorithm, vrsuit, factory, terra, dyson, ftl,
					undergrad, graduate, postdoc, prof, nobel, tube, clone, construct, optimizer, brain,
					eniac, apple, tsdelta, tianhe, dwave, cluster, machine, parallel, breaker, ai];
...
var investments = [inv0, inv1, inv2, inv3, inv4, inv5, inv6, inv7, inv8, inv9];
...
var people = [per0, per1, per2, per3, per4, per5, per6, per7, per8, per9];
...
var theories = [the0, the1, the2, the3, the4, the5, the6, the7, the8, the9, the10, the11];
